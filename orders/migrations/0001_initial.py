            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="cargo_types.Commodity",
                    ),
                ),
                (
                    "desired_rates",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="rates.Rate"
                    ),
                ),
                (
                    "destination",
                    models.ManyToManyField(
                        blank=True, related_name="received_orders", to="depots.Depot"
                    ),
                ),
                (
                ...
                (
                    "origin",
                    models.ManyToManyField(
                        blank=True, related_name="sent_orders", to="depots.Depot"
                    ),
                ),
                (
                    "owner",
