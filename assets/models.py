...
class AssetManager(models.Manager):
    ...
    def create_truck(self, name=None, owned_by=None, type=None, reg_no=None, haulage=None):
        """
        ...
        enforce_all_required_arguments_are_truthy(
            {'name': name,  'reg_no': reg_no, 'owned_by': owned_by, 'type': type, 'haulage': haulage}, REQUIRED_ARGS)
        truck = self.model(name=name, type=type, owned_by=owned_by,reg_no=reg_no, haulage=haulage)
        truck.save()
        return truck

    def create_trailer(self, name=None, owned_by=None, type=None, reg_no=None, haulage=None):
        """
        method that creates and returns trailer
        """
        REQUIRED_ARGS = ('name','owned_by', 'reg_no', 'type')
        enforce_all_required_arguments_are_truthy({'name': name, 'type': type, 'owned_by': owned_by,'reg_no':reg_no, 'haulage': haulage}, REQUIRED_ARGS)
        trailer = self.model(name=name, type=type, owned_by=owned_by, reg_no=reg_no, haulage=haulage)
        trailer.save()
        return trailer
