...
class RatesManager(models.Manager):
    ...
    def create_rates(self, price_per_kg=Decimal(0), price_per_km=Decimal(0), price_per_truck=Decimal(0), preferred_currency=None, created_by=None):
        """
...
class Rate(AbstractBaseModel, models.Model):
    ...
    price_per_km = models.DecimalField(decimal_places=4, max_digits=12, blank=True, default=Decimal(0))
    price_per_truck = models.DecimalField(decimal_places=4, max_digits=12, blank=True, default=Decimal(0))
