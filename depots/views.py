...
class DepotList(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        return (Depot.active_objects.get_depot(user=user) | Depot.active_objects.get_public(is_public=True))
    ...
    def post(self, request, format=None):
        ...
        serializers.save()
        response = {
            "depot": serializers.data,
            "message": "depot created succesfully"
        }
